...
import { INITIAL_MENU, INITIAL_STATE_MENU } from "@/constants/menu-constans";
...
export default function DialogCreateMenu({ refetch }: { refetch: () => void }) {
  ...
  const [createMenuState, createMenuAction, isPandingCreateMenu] =
